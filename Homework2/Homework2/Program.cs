...
it was the grayish white of old porridge.";
        ...
        {
            prvni = string.Compare(blabol1, blabol3) < 0 ? blabol1 : blabol3;
        }
        else
        {
            prvni = string.Compare(blabol2, blabol3) < 0 ? blabol2 : blabol3;
        }
        ...
        int indexKonec = text.IndexOf("!");
        int indexZacatek = 0;
        for (int i = indexKonec; i >= 0; i--)
        {
        ...
        string veta = text.Substring(indexZacatek, indexKonec - indexZacatek);
        ...
        while (index != -1)
        {
            index = text.IndexOf(" and ", index + 3, StringComparison.OrdinalIgnoreCase);
            pocetAnd++;
        }
        pocetAnd--;
        ...
        int pocetAnd = text.Split(new string[] { " and ", " And " }, StringSplitOptions.None).Length - 1;
